...
--   ('sample-1', 'Complete project documentation', 1696800000000, 1, false, '{}'),
--   ('sample-2', 'Review pull requests', 1696800100000, 2, false, '{}'),
--   ('sample-3', 'Team meeting preparation', 1696800200000, 3, true, '{}');
...
COMMENT ON COLUMN tasks.priority IS 'Task priority level (1 = high, 2 = medium, 3 = low)';
